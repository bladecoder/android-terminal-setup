...
- Automated bootstrap from a clean Android Terminal install
...
```sh
curl -fsSL https://raw.githubusercontent.com/bladecoder/android-terminal-setup/main/bootstrap.sh | sh
```
...
```
git clone https://github.com/bladecoder/android-terminal-setup.git
